package com.example.davidschang.currencyconverter;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void convert(View view) {
        ...
        Double dollarAmountEditDouble = Double.parseDouble(dollarAmountEditText.getText().toString());

        Double poundAmount = dollarAmountEditDouble * 0.82;
